    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ComparisonProduct", x => new { x.ComparesId, x.ProductsId });
                    table.ForeignKey(
                        name: "FK_ComparisonProduct_Comparisons_ComparesId",
